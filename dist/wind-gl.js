...
var WindGL = function WindGL(gl) {
  ...
  this.dropRate = 0.0039; // how often the particles move to a random place
  this.dropRateBump = 0.014; // drop rate increase relative to individual particle speed
